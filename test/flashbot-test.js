...
describe("FlashBot", function () {
    ...
    it("computeSwapAmountOut", async function () {
        let param = {
            amountIn: ethers.BigNumber.from("10000000000000000000"),
            path: [
                "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270", // WMATIC
                // "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174", // USDC
                "0x071ab2bf3cb7c51897d74cec58a47ae85d655956", // TOKEN
                "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270" // WMATIC
            ],
            router: [
                "0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506", // router0
                "0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff" // router1
            ]
        }
    ...
    it("executeSwap", async function () {
        ...
        let param = {
            ...
            router: [
                "0x5C6EC38fb0e2609672BDf628B1fD605A523E5923", // router1
                "0x736FD9EabB15776A3adfea1B975c868F72A29d14" // router2
            ]
        }
        let amountOut = await flashBot.computeSwapAmountOut(param);
